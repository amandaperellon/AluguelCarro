...
class LocacaoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Locacao');
	...
	{
		$model=new Locacao('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Locacao']))
			$model->attributes=$_GET['Locacao'];
	...
	{
		$model=Locacao::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Locacao $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='locacao-form')
		{
